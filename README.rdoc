...
Sidecar is a utility which runs along side your rails server in development.  It runs your tests when files change, it pushes CSS changes directly to your browser, it pushes Javascript changes to your browser.  
